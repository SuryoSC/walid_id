<?php
    ...
    $id_jadwal = isset($_GET["jadwal_id"]) ? $_GET["jadwal_id"] : 0;
...
<body>
    ...
    <div class="mx-auto w-[90%] bg-gray-50 rounded-sm mb-16 p-6 shadow-md mt-10">
        <form action="panggil.php" method="GET">
            <label for="id" class="block text-gray-700 font-medium mb-1">Pilih Jadwal</label>
            <select name="jadwal_id" id="jadwal_id" required class="border border-gray-300 rounded-lg px-4 py-2 mb-3 focus:ring-2 focus:ring-sky-400 focus:outline-none transition duration-200">
