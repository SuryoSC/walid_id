            ...
            <form action="login.php" method="POST" class="flex flex-col items-center gap-5 py-5">
                ...
                <div class="w-[400px] flex flex-col gap-5">
                    <div class="flex flex-col">
                        ...
                        <input class="border-b-1 border-sky-400 outline-none  text-sm py-1 text-gray-500" type="text" class="form-control" placeholder="example123" name="username" required>
                    </div>
                    <div class="flex flex-col">
    ...
    <?php if($login_message === "gagal") : ?>
       <script>
            Swal.fire({
                icon: 'error',
                title: 'Gagal!',
                text: 'Data salah, gagal login sebagai admin.'
            });
       </script>
    <?php endif; ?>
</body>
